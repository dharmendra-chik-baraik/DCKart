    ...
    <div class="row my-3">
        <div class="col-12">
            <div class="page-title-box d-flex justify-content-between align-items-center">
                <h4 class="page-title h3 mb-0 text-gray-800">Approved Reviews</h4>
                                <div class="page-title-right">
                    <ol class="breadcrumb m-0">
                        <li class="breadcrumb-item"><a href="{{ route('admin.dashboard') }}">Dashboard</a></li>
                        <li class="breadcrumb-item"><a href="{{ route('admin.reviews.index') }}">Reviews</a></li>
                        <li class="breadcrumb-item active">Approved Reviews</li>
                    </ol>
                </div>
            </div>
        </div>
        ...
        <div class="col-xl-3 col-lg-4 col-sm-6">
            <div class="card widget-flat">
                <div class="card-body">
                    ...
                    <h5 class="text-muted fw-normal mt-0">Approved Reviews</h5>
            ...
            <div class="card">
                <div class="card-body">
                                ...
                                <tr class="table-success">
                                    ...
                                    <td>
                                        <div class="d-flex align-items-start">
                                            <div class="bg-success rounded text-white me-3 d-flex align-items-center justify-content-center" 
                                            ...
                                            <div style="max-width: 600px">
                                                ...
                                                @if($review->review)
                                                <p class="mb-0 text-dark">{{ Str::limit($review->review, 100) }}</p>
                                                @else
                                                <p class="mb-0 text-muted"><em>No review text provided</em></p>
                                                @endif
                                            </div>
                                        </div>
                                    </td>
                                    <td>
                                        <div class="d-flex align-items-start">
                                            ...
                                            <img src="{{ asset('storage/' . $review->product->images->first()->image_path) }}" 
                                                 alt="{{ $review->product->name }}" class="rounded me-2" width="40" height="40">
                                            @else
                                            ...
                                            <div>
                                                ...
                                                <small class="text-muted">by {{ $review->product->vendor->shop_name }}</small>
                                                <br>
                                    ...
                                    <td>
                                        <div class="btn-group-sm">
                                            <form action="{{ route('admin.reviews.mark-pending', $review->id) }}" method="POST" class="d-inline">
                                                @csrf
                                                <button type="submit" class="btn btn-sm btn-outline-warning" 
                                                        title="Mark as Pending" onclick="return confirm('Mark this review as pending?')">
                                            ...
                                            <form action="{{ route('admin.reviews.reject', $review->id) }}" method="POST" class="d-inline">
                                                ...
                                                <button type="submit" class="btn btn-sm btn-outline-danger" 
                                                        title="Reject Review" onclick="return confirm('Reject this review?')">
                    ...
                    <div class="text-center py-5">
                        ...
                        <h4 class="text-muted">No Approved Reviews</h4>
                        <p class="text-muted">There are no approved reviews yet.</p>
                        <a href="{{ route('admin.reviews.pending') }}" class="btn btn-primary">
                            <i class="fas fa-clock"></i> View Pending Reviews
                        </a>
                    </div>
                    @endif
                </div>
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="row">
                    <div class="col-md-4 text-center">
                        <img id="modalProductImage" src="" alt="Product Image" class="img-fluid rounded mb-3" 
            ...
            <div class="modal-footer">
                <form id="modalPendingForm" method="POST" class="d-inline">
                    @csrf
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        reviewDetailModal.addEventListener('show.bs.modal', function(event) {
            ...
            document.getElementById('modalReviewText').textContent = reviewText || 'No review text provided';
            ...
            base_url = "{{ url('/') }}";
            // Set form actions
            document.getElementById('modalPendingForm').action = base_url + `/admin/reviews/${reviewId}/pending`;
        ...
        bulkAction.addEventListener('change', function() {
            bulkActionButton.disabled = document.querySelectorAll('.review-checkbox:checked').length === 0;
        });
