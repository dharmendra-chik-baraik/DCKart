...
@section('title', 'Rejected Reviews')
        ...
        <div class="row my-3">
            <div class="col-12">
                <div class="page-title-box d-flex justify-content-between align-items-center">
                    <h4 class="page-title h3 mb-0 text-gray-800">Rejected Reviews</h4>
            ...
            <div class="col-xl-3 col-lg-4 col-sm-6">
                <div class="card widget-flat">
                    <div class="card-body">
                        ...
                        <h5 class="text-muted fw-normal mt-0">Rejected Reviews</h5>
                    ...
                    <div class="card-body">
                                            ...
                                            <tr class="table-danger">
                                                ...
                                                <td>
                                                    <div class="d-flex align-items-start">
                                                        <div class="bg-danger rounded text-white me-3 d-flex align-items-center justify-content-center"
                                                    ...
                                                    <div class="btn-group">
                                                        ...
                                                        <form
                                                            ...
                                                            <button type="submit" class="btn btn-sm btn-outline-warning"
                                                                ...
                                                                onclick="return confirm('Mark this review as pending?')">
                        ...
                        @else
                            <div class="text-center py-5">
                                ...
                                <h4 class="text-muted">No Rejected Reviews</h4>
                                <p class="text-muted">There are no rejected reviews.</p>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            reviewDetailModal.addEventListener('show.bs.modal', function(event) {
                ...
                // Set form actions
                document.getElementById('modalApproveForm').action = base_url +
                    `/admin/reviews/${reviewId}/approve`;
                document.getElementById('modalPendingForm').action = base_url +
                    `/admin/reviews/${reviewId}/pending`;
            });
